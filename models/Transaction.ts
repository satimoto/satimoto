...
export class TransactionModel implements TransactionModelInterface {
    ...
    addTransaction(transaction: InvoicePaymentModel) {
        ...
        if (index === -1) {
            ...
            this.subtransactions.push(transaction)
        } else {
    ...
    get feeMsat(): string {
        return this.subtransactions
            ...
            .reduce((feeMsat, transaction) => {
                ...
                return payment ? feeMsat.subtract(payment.feeMsat) : feeMsat
            }, new Long(0))
            .toString()
    }
    ...
    get feeSat(): string {
        return this.subtransactions
            ...
            .reduce((feeSat, transaction) => {
                const payment = transaction as PaymentModel
                return payment ? feeSat.subtract(payment.feeSat) : feeSat
            }, new Long(0))
            .toString()
    }
    ...
    get valueMsat(): string {
        return this.subtransactions
            ...
            .reduce((valueMsat, transaction) => {
                return (transaction as InvoiceModel) ? valueMsat.add(transaction.valueMsat) : valueMsat.subtract(transaction.valueMsat)
            }, new Long(0))
            .toString()
    }
    ...
    get valueSat(): string {
        return this.subtransactions
            ...
            .reduce((valueSat, transaction) => {
                return (transaction as InvoiceModel) ? valueSat.add(transaction.valueSat) : valueSat.subtract(transaction.valueSat)
            }, new Long(0))
            .toString()
    }
}
