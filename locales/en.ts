export default {
    ...
    CloseChannelModal_Text: "Enter a Bitcoin address to send funds to:",
    CloseChannelModal_ControlText: "Make sure you are in control of this address.",
    CloseChannelModal_ConfirmText: "This transaction may take several blocks to confirm.",
