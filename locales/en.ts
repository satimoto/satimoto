export default {
    ...
    CircuitCard_AboutCircuitTitle: "Recharge",
    CircuitCard_AboutCircuitText: "By sharing Satimoto with your family, friends, or social network, each time a referred person charges their vehicle, you receive a split.",
    CircuitCard_MoreInfoText: "Each and every time, forever.",
    CircuitCard_ButtonText: "Enable",
    ...
    ReceiveActionsheet_ReceiveLnurl: "Receive using LNURL",
    ReceiveActionsheet_ReceiveQr: "Receive using Invoice",
    ReceiveActionsheet_ReceiveNfc: "Receive using NFC card",
    ...
    ReceiveLnUrl_HeaderTitle: "Receive with LNURL",
    ...
    SettingsAdvanced_TraceLogEnabledText: "Trace Log Enabled",
    SettingsAdvanced_TraceLogEnabledHint: "Enable detail backend logging (restart required)",
