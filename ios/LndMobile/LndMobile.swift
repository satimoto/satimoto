...
class LndMobile: RCTEventEmitter, LndStreamEventProtocol {
  ...
  static let syncMethods: [String:LndMobileSyncMethod] = [
    ...
    // Invoice RPC
    "AddHoldInvoice": { (msg: Data?, cb: LndCallback) in LndmobileInvoicesAddHoldInvoice(msg, cb) },
    "CancelInvoice": { (msg: Data?, cb: LndCallback) in LndmobileInvoicesCancelInvoice(msg, cb) },
    "SettleInvoice": { (msg: Data?, cb: LndCallback) in LndmobileInvoicesSettleInvoice(msg, cb) },
    // Router RPC
    "BuildRoute": { (msg: Data?, cb: LndCallback) in LndmobileRouterBuildRoute(msg, cb) },
    "EstimateRouteFee": { (msg: Data?, cb: LndCallback) in LndmobileRouterEstimateRouteFee(msg, cb) },
    "GetMissionControlConfig": { (msg: Data?, cb: LndCallback) in LndmobileRouterGetMissionControlConfig(msg, cb) },
    "QueryMissionControl": { (msg: Data?, cb: LndCallback) in LndmobileRouterQueryMissionControl(msg, cb) },
    "QueryProbability": { (msg: Data?, cb: LndCallback) in LndmobileRouterQueryProbability(msg, cb) },
    "ResetMissionControl": { (msg: Data?, cb: LndCallback) in LndmobileRouterResetMissionControl(msg, cb) },
    "SendToRoute": { (msg: Data?, cb: LndCallback) in LndmobileRouterSendToRoute(msg, cb) },
    "SendToRouteV2": { (msg: Data?, cb: LndCallback) in LndmobileRouterSendToRouteV2(msg, cb) },
    "SetMissionControlConfig": { (msg: Data?, cb: LndCallback) in LndmobileRouterSetMissionControlConfig(msg, cb) },
    "UpdateChanStatus": { (msg: Data?, cb: LndCallback) in LndmobileRouterUpdateChanStatus(msg, cb) },
    "XImportMissionControl": { (msg: Data?, cb: LndCallback) in LndmobileRouterXImportMissionControl(msg, cb) },
    // Signer RPC
    "ComputeInputScript": { (msg: Data?, cb: LndCallback) in LndmobileSignerComputeInputScript(msg, cb) },
    "DeriveSharedKey": { (msg: Data?, cb: LndCallback) in LndmobileSignerDeriveSharedKey(msg, cb) },
    ...
    // Wallet RPC
    "BumpFee": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitBumpFee(msg, cb) },
    "DeriveKey": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitDeriveKey(msg, cb) },
    "DeriveNextKey": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitDeriveNextKey(msg, cb) },
    "WalletKitEstimateFee": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitEstimateFee(msg, cb) },
    "FinalizePsbt": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitFinalizePsbt(msg, cb) },
    "FundPsbt": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitFundPsbt(msg, cb) },
    "ImportAccount": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitImportAccount(msg, cb) },
    "ImportPublicKey": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitImportPublicKey(msg, cb) },
    "LabelTransaction": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitLabelTransaction(msg, cb) },
    "LeaseOutput": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitLeaseOutput(msg, cb) },
    "ListAccounts": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitListAccounts(msg, cb) },
    "ListLeases": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitListLeases(msg, cb) },
    "ListSweeps": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitListSweeps(msg, cb) },
    "ListUnspent": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitListUnspent(msg, cb) },
    "NextAddr": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitNextAddr(msg, cb) },
    "PendingSweeps": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitPendingSweeps(msg, cb) },
    "PublishTransaction": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitPublishTransaction(msg, cb) },
    "ReleaseOutput": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitReleaseOutput(msg, cb) },
    "SendOutputs": { (msg: Data?, cb: LndCallback) in LndmobileWalletKitSendOutputs(msg, cb) },
]
  ...
  static let recvStreamMethods: [String:LndMobileRecvStreamMethod] = [
    ...
    // Chain RPC
    "RegisterBlockEpochNtfn": { (msg: Data?, cb: LndRecvStream) in LndmobileChainNotifierRegisterBlockEpochNtfn(msg, cb) },
    "RegisterConfirmationsNtfn": { (msg: Data?, cb: LndRecvStream) in LndmobileChainNotifierRegisterConfirmationsNtfn(msg, cb) },
    "RegisterSpendNtfn": { (msg: Data?, cb: LndRecvStream) in LndmobileChainNotifierRegisterSpendNtfn(msg, cb) },
    // Invoice RPC
    "SubscribeSingleInvoice": { (msg: Data?, cb: LndRecvStream) in LndmobileInvoicesSubscribeSingleInvoice(msg, cb) },
    // Router RPC
    "SendPayment": { (msg: Data?, cb: LndRecvStream) in LndmobileRouterSendPayment(msg, cb) },
    "SendPaymentV2": { (msg: Data?, cb: LndRecvStream) in LndmobileRouterSendPaymentV2(msg, cb) },
    "SubscribeHtlcEvents": { (msg: Data?, cb: LndRecvStream) in LndmobileRouterSubscribeHtlcEvents(msg, cb) },
    "TrackPayment": { (msg: Data?, cb: LndRecvStream) in LndmobileRouterTrackPayment(msg, cb) },
    "TrackPaymentV2": { (msg: Data?, cb: LndRecvStream) in LndmobileRouterTrackPaymentV2(msg, cb) },
  ]
  ...
  static let biStreamMethods: [String:LndMobileBiStreamMethod] = [
    ...
    // Router RPC
    "HtlcInterceptor": { (cb: LndRecvStream, err: inout NSError?) in return LndmobileRouterHtlcInterceptor(cb, &err) },
]
